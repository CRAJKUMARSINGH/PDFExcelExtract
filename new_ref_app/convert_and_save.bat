...
echo to both Word and Excel formats and save them in an
echo "output" folder.
echo.
...
pip install PyPDF2 python-docx openpyxl >nul 2>&1
if %errorlevel% neq 0 (
    echo Installing with python -m pip...
    python -m pip install PyPDF2 python-docx openpyxl >nul 2>&1
    if %errorlevel% neq 0 (
        color 0C
        echo.
...
echo.
python "%~dp0pdf_to_word_excel.py"
...
echo =====================================================
echo.
echo Check the "output" folder for your converted files.
echo.
